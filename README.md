# [Flask Dashboard](https://appseed.us/admin-dashboards/flask) [Gradient Able](https://appseed.us/admin-dashboards/flask-dashboard-gradient-pro)
...
[Gradient Able](https://appseed.us/admin-dashboards/flask-dashboard-gradient-pro) Bootstrap 4 Free/Lite Admin Template is a complete solution for your dashboard creation. It combines colors that are easy on the eye, spacious cards, beautiful typography, and graphics.
...
---
[Flask Dashboard](https://appseed.us/admin-dashboards/flask) [Gradient Able](https://appseed.us/admin-dashboards/flask-dashboard-gradient-pro) - Provided by **AppSeed [App Generator](https://appseed.us/app-generator)**.
