...
Open-source **Flask Dashboard** generated by `AppSeed` op top of a modern design. **[Gradient Able](https://appseed.us/product/gradient-able/flask/)** Bootstrap Lite is the most stylised Bootstrap 5 Admin Template, around all other Lite/Free admin templates in the market. It comes with high feature-rich pages and components with fully developer-centric code. 
